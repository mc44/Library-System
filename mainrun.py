...
class Page3(tk.Frame):
    def __init__(self, parent, controller):
        ...
        my_tree1 = ttk.Treeview(tree_frame1, yscrollcommand=tree_scroll1.set)
        my_tree1['columns'] = (
            "ID", "Name", "Location", "Date", "Time", "Type", "Notes", "Expenses")
        my_tree1.column("#0", width=0, stretch="NO")
        ...
        my_tree1.column("Date", anchor="center", width=40)
        my_tree1.column("Time", anchor="center", width=40)
        ...
        my_tree1.heading("Date", text="Date", anchor="center")
        my_tree1.heading("Time", text="Time", anchor="center")
